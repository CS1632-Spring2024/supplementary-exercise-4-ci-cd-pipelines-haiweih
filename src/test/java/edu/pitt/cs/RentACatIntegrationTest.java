...
public class RentACatIntegrationTest {
	...
	public void testGetCatNullNumCats0() {
		...
		try {
			...
			Object obj = getCatMethod.invoke(r,2);
			assertNull(obj);
			assertEquals("Invalid cat ID." + newline,out.toString());
		}
		catch (NoSuchMethodException|IllegalAccessException|InvocationTargetException e){
			System.out.println("Failure in testGetCatNullNumCats0" + newline);
		}
	}
	...
	public void testGetCatNumCats3() {
		...
		try {
			...
			assertNotNull(obj);
			Cat aCat = (Cat) obj;
			assertEquals(aCat.getId(), 2);
		}
		catch (NoSuchMethodException|IllegalAccessException|InvocationTargetException e){
			System.out.println("Failure in testGetCatNumCats3" + newline);
		}
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		when(mockedCat2.getId()).thenReturn(2);
		when(mockedCat2.getRented()).thenReturn(true);
		when(mockedCat2.getName()).thenReturn("Old Deuteronomy");
